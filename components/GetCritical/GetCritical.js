...
const GetCritical = () => {
  return (
   ...
   <div className="margin  bg-green w-[73.125rem] h-[23.375rem] rounded-2xl flex flex-col justify-center items-center text-center mt-[9rem] md:w-auto md:h-auto md:mx-4 md:p-5 md:hidden">
